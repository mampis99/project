    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">SEWING PACKAGE</h3>
        </div>
        <div class="box-body">
          ...
          <div class="col-md-4">
            <div class="box box-info">
              <div class="box-header with-border">
                <i class="fa fa-text-width"></i>
                <h2 class="box-title">Intermediate Sewing Package</h2>
              </div>
              <div class="box-body">
                <img class="img-responsive" src="{{ URL::asset('adminlte/dist/img/photo1.png') }}" alt="Photo">
          ...
          <div class="col-md-4">
            <div class="box box-info">
              <div class="box-header with-border">
                <i class="fa fa-text-width"></i>
                <h2 class="box-title">Advance Sewing Package</h2>
              </div>
              <div class="box-body">
                <img class="img-responsive" src="{{ URL::asset('adminlte/dist/img/photo1.png') }}" alt="Photo">
                ...
                <a class="btn btn-primary btn-block" href="{{'/siswa/paket/paket13'}}">Lihat Detail</a>
              </div>
            </div>
          </div>
